...
<body>
    ...
    <div class="container">
        <form action="<?php echo base_url().'/patient/signup';?>" method="post" enctype="multipart/form-data">
        <!--  page-wrapper -->
            <div class="row">
                <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">REGISTER PATIENT</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-10 align-content-center">
                                    <div class="row">
                                    	<div class="form-group">
                                        	<div class="col-md-6">
                                            	...
                                            	<input class="form-control" name="NamePa" type="text" required />
                                            	<p class="help-block"></p>
                                        	</div>
                                        	<div class="col-md-6">
                                    ...
                                    <div class="row">
                                    	<div class="form-group">
                                            <div class="col-md-6">
                                                <label>¿You Smoke?</label>
                                                <select id="smoke" name="smoker" class="form-control" required>
                                                    <option value="0" selected>NO</option>
                                                    <option value="1">YES</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label>¿Chronic Desease?</label>
                                                <select id="chronicdesease" name="chronicdesease" class="form-control" required>
                                                    <option value="0" selected>NO</option>
                                                    <option value="1">YES</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                        <div class="col-md-6">
                                            	<label>Your Current Height</label>
                                            	<input class="form-control" name="myheight" type="number" step="0.01" required />
                                            	<p class="help-block"></p>
                                        	</div>
                                        	<div class="col-md-6">
                                            	<label>Your Current Weight</label>
                                            	<input class="form-control" name="myweight" type="number" step="0.01" required />
                                            	<p class="help-block"></p>
                                        	</div>
                                    	</div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <label>Note of Chronic Desase</label>
                                                <textarea name="note_chronic_desease" col="25" rows="5" class="form-control" require>A brief description of your desease</textarea>
                                            </div>
                                            <div class="col-md-6">
                                            	<label>Family Desease History</label>
                                            	<textarea name="family_desease_history" col="25" rows="5" class="form-control" require>A brief description of your disease history</textarea>
                                            </div>
                                    	</div>
                                    </div>
                                    <!--
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input name='PaPicture' id='input-file' type='file' />
                                                <br />
                                                <img id='imgSalida' width='200px' height='200px' src='Image to load' />
                                            </div>
                                            <div class="col-md-6">
